const ContactLineComponent = () => (
    <div>
        <nav className="h-[40px] flex gap-1 opacity-50">
            <svg className="h-[20px] w-[20px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g>
            ...
            <p className="text-lg -translate-y-1 font-medium">Email</p>
        </nav>
        <nav>
            <p>xxxxx@xxx.xxx</p>
        </nav>
...
export default ContactLineComponent;